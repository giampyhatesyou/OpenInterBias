                    ...
                    for remaining_cluster in remaining_clusters:
                        ...
                        if remaining_cluster not in clusters_merged:
                            ...
                            if overlap >= merge_threshold:
                                ...
                                # CHANGED (fork) - START: del -> pop(key, None). After several
                                # merges of the same bias these keys can already be gone (the
                                # current/main string was rewritten on a previous iteration); which
                                # iteration hits this depends on set() ordering, i.e. on
                                # PYTHONHASHSEED -> the intermittent KeyError. pop keeps the
                                # surviving-key behavior.
