...
GEN_SETTING = {
    ...
    'max_prompts_per_bias': 2, # maximum number of prompts per bias, e.g., if a specific bias has N>max_prompts_per_bias support, only the first <max_prompts_per_bias> prompts will be used
